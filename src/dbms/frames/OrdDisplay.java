 ...
 * @author HP
 */
public class OrdDisplay extends javax.swing.JFrame {

    /**
     * Creates new form OrdDisplay
     */
    public OrdDisplay() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OrdDisplay.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OrdDisplay().setVisible(true);
            }
        });
    }
